...
const AdminLogin = () => {
  ...
  const onFinish = async (values) => {
    try {
      ...
      if (data.success) {
        console.log("Affichage message de succès connexion admin");
        messageApi.success({
          content: data.message || "Connexion réussie",
          style: {
            color: "#fff !important",
        ...
        console.log("Affichage message d'erreur connexion admin");
        messageApi.error({
      ...
      console.error("Erreur réseau lors de la connexion admin:", err);
      console.log("Affichage message d'erreur réseau connexion admin");
      messageApi.error({
        ...
        >
          ...
          <div>
            ...
            <Text style={{ color: lightMode ? "#555" : "#ccc" }}>
              Sign in to manage Sayes Performance
            </Text>
          </div>
        </div>
        ...
        >
          ...
          <Form.Item>
            <Text style={{ color: lightMode ? "#555" : "#ccc" }}>
              ...
              <a href="/admin-register" style={{ color: "#c21d56" }}>
                Register as admin
              </a>
            </Text>
          </Form.Item>
